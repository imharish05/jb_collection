...
const timelessTreasuresSlice = createSlice({
...
export const { setLoading, setItems, setError, addItem, updateItem, removeItem } = timelessTreasuresSlice.actions;
export default timelessTreasuresSlice.reducer;