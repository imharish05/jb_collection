...
export default function Dashboard() {
  ...
  const STAT_CARDS = [
    ...
    { label: 'Total GST', value: typeof stats.totalGST === 'number' ? `₹${stats.totalGST.toLocaleString('en-IN')}` : stats.totalGST, bg: 'linear-gradient(135deg,#8252e9 0%,#6a3bd0 100%)', icon: (<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 14l2 2 4-4" /><circle cx="12" cy="12" r="10" /></svg>) },
    { label: 'Total Shipping', value: typeof stats.totalShipping === 'number' ? `₹${stats.totalShipping.toLocaleString('en-IN')}` : stats.totalShipping, bg: 'linear-gradient(135deg,#0ea5b8 0%,#0b8595 100%)', icon: (<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="1" y="3" width="15" height="13" /><path d="M16 8h4l3 5v3h-7V8z" /><circle cx="5.5" cy="18.5" r="2.5" /><circle cx="18.5" cy="18.5" r="2.5" /></svg>) },
