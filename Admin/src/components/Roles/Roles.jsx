...
const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "timeless_view", label: "View Signature Collection" },
      { key: "timeless_create", label: "Add Signature Collection" },
      { key: "timeless_edit", label: "Edit Signature Collection" },
      { key: "timeless_delete", label: "Delete Signature Collection" },
