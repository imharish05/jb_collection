          ...
          {Array.from({ length: dotCount }).map((_, i) => (
            <button
              ...
              style={{
                ...
                background: i === dotIdx ? "var(--theme-color)" : "#D1D5DB",
...
function MixMatchCard({ cp, selected, onToggle }) {
  ...
  return (
    <div
      ...
      style={{
        border: `2px solid ${selected ? "var(--theme-color)" : "#E5E7EB"}`,
    ...
    >
      {selected && (
        <div style={{ position: "absolute", top: 6, right: 6, width: 20, height: 20, borderRadius: "50%", background: "var(--theme-color)", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 700, zIndex: 1 }}>✓</div>
      )}
      <div style={{ paddingTop: "75%", position: "relative", background: "#F9FAFB", overflow: "hidden" }}>
        {img
          ? <img src={img} alt={prod?.name} style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
    ...
    return (
      <LayoutOne headerTop="visible">
        <div style={{ padding: "120px 0", textAlign: "center", color: "#6B7280" }}>
          ...
          <Link to={`${process.env.PUBLIC_URL}/shop`} style={{ color: "var(--theme-color)", fontWeight: 600 }}>← Back to Shop</Link>
        </div>
      </LayoutOne>
    );
  }
    ...
    return (
      <LayoutOne headerTop="visible">
        <div style={{ padding: "120px 0", textAlign: "center", color: "#6B7280" }}>
          ...
          <Link to={`${process.env.PUBLIC_URL}/shop`} style={{ color: "var(--theme-color)" }}>← Shop</Link>
        </div>
      </LayoutOne>
    );
  }
  ...
  return (
    <Fragment>
              ...
              <div className="col-lg-6 col-md-6">
                <div className="combo-details-content">
                  ...
                  <div className="product-details-price" style={{ marginBottom: 16 }}>
                    <span className="final-price" style={{ fontSize: 30, fontWeight: 900, color: "var(--theme-color)" }}>
                      ...
                      <div style={{ marginBottom: 12 }}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                          <div style={{ flex: 1, height: 6, background: "#E5E7EB", borderRadius: 3, overflow: "hidden" }}>
                            <div style={{ height: "100%", width: `${Math.min(100, progressPct)}%`, background: canAdd ? "#22c55e" : "var(--theme-color)", borderRadius: 3, transition: "width 0.3s" }} />
                          </div>
                          <span style={{ fontSize: 12, fontWeight: 700, color: canAdd ? "#22c55e" : "var(--theme-color)", flexShrink: 0 }}>
                                          ...
                                          <div>
                                            ...
                                            <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginTop: 4 }}>
                                              <div style={{ position: 'relative', width: 40, height: 40, borderRadius: 8, overflow: 'hidden', border: '1px solid #d1d5db', cursor: 'pointer', flexShrink: 0 }}>
                                                <input
                                                  type="color"
                                                  value={customisationDetails[errorKey] && customisationDetails[errorKey].startsWith('#') ? customisationDetails[errorKey] : 'var(--theme-color)'}
                                                  onChange={e => setCustomisationDetails(prev => ({ ...prev, [errorKey]: e.target.value }))}
                                                  ...
                                                  return (
                                                    <button
                                                      ...
                                                      style={{
                                                        ...
                                                        gap: 6,
                                                        padding: '5px 10px',
                                                        border: isSelected ? '2px solid var(--theme-color)' : '1px solid #d1d5db',
                                                        borderRadius: 20,
                                                        background: isSelected ? '#FEF0EB' : '#fff',
                                                        color: isSelected ? 'var(--theme-color)' : '#374151',
                                                        fontSize: 12,
                                                        fontWeight: 500,
                                                        cursor: 'pointer',
                                                        transition: 'all 0.2s',
      ...
      <style>{`
        ...
        .pdp-qty__btn:hover:not(:disabled) { background: #f3f4f6; color: var(--theme-color); }
