...
import { addToCartService, deleteFromWishlistService, deleteAllFromWishlistService } from "../../store/services";
                              ...
                              <tr key={key}>
                                <td className="product-thumbnail">
                                  ...
                                  >
                                    <img
                                      className="img-fluid"
                                      src={getImgUrl(getFirstImage(wishlistItem.image))}
                                      alt=""
                                    />
                                  </Link>
                                </td>
                                ...
                                <td className="product-remove">
                                  <button
                                    onClick={() =>
                                      deleteFromWishlistService(wishlistItem.id)
                                    }
                                  >
                  ...
                  <div className="col-lg-12">
                    <div className="cart-shiping-update-wrapper">
                      ...
                      <div className="cart-clear">
                        <button onClick={() => deleteAllFromWishlistService()}>
                          Clear Wishlist
                        </button>
                      </div>
                    </div>
