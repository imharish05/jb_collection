...
const Wishlist = () => {
  ...
  return (
    <Fragment>
      <SEO title="My Wishlist" titleTemplate="Saved Products - JB Collections" description="View your saved products list at JB Collections. Save your favorite grocery, apparel, home, and beauty items for later purchase." keywords="wishlist, saved products, shopping wishlist, shopping list, JB Collections" />
      <LayoutOne headerTop="visible">
        ...
        {wishlistItems && wishlistItems.length >= 1 ? (
              ...
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:12, marginBottom:28 }}>
                ...
                <div style={{ display:"flex", gap:10 }}>
                  ...
                  <button
                    ...
                    style={{ display:"inline-flex", alignItems:"center", gap:6, padding:"10px 20px", background:"#fff5f8", border:"1.5px solid #fca5a5", borderRadius:10, fontSize:13, fontWeight:700, color:"var(--theme-color)", cursor:"pointer" }}
                  >
                    🗑 Clear Wishlist
                  </button>
                </div>
          ...
          <div style={{ textAlign:"center", padding:"100px 20px", display:"flex", flexDirection:"column", alignItems:"center", gap:20 }}>
            ...
            <Link
              to={process.env.PUBLIC_URL + "/shop"}
              style={{ display:"inline-flex", alignItems:"center", gap:8, padding:"13px 28px", background:"linear-gradient(135deg,var(--theme-color),#c01550)", color:"#fff", borderRadius:12, fontSize:14, fontWeight:700, textDecoration:"none", boxShadow:"0 4px 14px rgba(219,26,93,0.28)", marginTop:4 }}
            >
              Explore Products →
            </Link>
          </div>
