...
import { addToCartService, deleteFromCompareService } from "../../store/services";
...
const Compare = () => {
  ...
  return (
    <Fragment>
      <SEO
        titleTemplate="Compare - JB House of Fashion"
        description="Compare your favorite gifts and find the perfect personalized gift at JB House of Fashion."
      />
                              ...
                              return (
                                <td className="product-image-title" key={key}>
                                  <div className="compare-remove">
                                    <button
                                      onClick={() =>
                                        deleteFromCompareService(compareItem.id)
                                      }
                                    >
