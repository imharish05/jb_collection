          ...
          <div className="policy-body">
            ...
            <div className="policy-section" id="pay-2">
              ...
              <ul className="policy-ul">
                ...
                <li>Razorpay's own <a href="https://razorpay.com/privacy/" target="_blank" rel="noopener noreferrer" style={{ color: "var(--theme-color)" }}>Privacy Policy</a> and <a href="https://razorpay.com/terms/" target="_blank" rel="noopener noreferrer" style={{ color: "var(--theme-color)" }}>Terms of Service</a> govern the payment processing portion of your transaction</li>
              </ul>
            </div>
            ...
            <div className="policy-section" id="pay-4">
              ...
              <div className="policy-highlight">
                <p>JB House of Fashion will <strong>never</strong> ask you for your card number, CVV, OTP, UPI PIN, or net banking credentials via email, phone, or WhatsApp. If you receive such a request claiming to be from JB House of Fashion, it is a phishing attempt — report it to <strong>jbbeautyandfashion@gmail.com</strong> immediately.</p>
              </div>
            </div>
            ...
            <div className="policy-section" id="pay-5">
              ...
              <ul className="policy-ul">
                ...
                <li>If pending for more than <strong>24 hours</strong>, contact us at <strong>jbbeautyandfashion@gmail.com</strong> with your Order ID and we will investigate via Razorpay's dashboard</li>
              </ul>
            ...
            <div className="policy-section" id="pay-9">
              ...
              <ul className="policy-ul">
                <li>If you have an issue with an order, we strongly request that you <strong>contact us first</strong> at <strong>jbbeautyandfashion@gmail.com</strong> before raising a chargeback; most issues are resolved within 24–48 hours</li>
