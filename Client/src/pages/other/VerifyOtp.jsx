              ...
              <div className="form-body" style={{ paddingTop: "12px" }}>
                ...
                <div style={{ textAlign: "center", marginBottom: "24px" }}>
                  <div style={{
                    ...
                    <ShieldCheck size={32} color="var(--theme-color)" />
                  </div>
                  <h3 style={{ margin: "12px 0 4px", fontSize: "18px", fontWeight: "700", color: "#2c2c2c" }}>
                    Enter Verification Code
                  </h3>
                  <p style={{ margin: 0, fontSize: "13px", color: "#777" }}>
                    OTP sent to <strong style={{ color: "var(--theme-color)" }}>{email}</strong>
                  </p>
                </div>
                  ...
                  <div style={{ textAlign: "center", marginBottom: "20px" }}>
                    {!canResend ? (
                      <p style={{ fontSize: "13px", color: "#888", margin: 0 }}>
                        Resend OTP in{" "}
                        <span style={{ color: "var(--theme-color)", fontWeight: "700", fontFamily: "monospace" }}>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          color: "var(--theme-color)", fontSize: "13px", fontWeight: "600",
