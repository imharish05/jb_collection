    ...
    >
      <style>
        {`
          ...
          .wave-path-1 { animation: wave-sway-1 8s ease-in-out infinite; }
          .wave-path-2 { animation: wave-sway-2 10s ease-in-out infinite; }
          .wave-path-3 { animation: wave-sway-3 12s ease-in-out infinite; }
        `}
      </style>
      {/* Top curvy border */}
      <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', overflow: 'hidden', lineHeight: 0, zIndex: 10 }}>
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" style={{ position: 'relative', display: 'block', width: 'calc(100% + 100px)', height: '40px', marginLeft: '-50px' }}>
