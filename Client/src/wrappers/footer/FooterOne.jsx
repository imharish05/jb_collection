          ...
          <div className="km-footer-inner">
            ...
            <div className="km-brand-col">
              ...
              <div className="km-social">
                <a href="#" className="km-ig" aria-label="Instagram">
                ...
                <a href="#" className="km-fb" aria-label="Facebook">
                ...
                <a href="https://wa.me/7338814319" className="km-wa" aria-label="WhatsApp">
            ...
            <div className="km-contact-col">
              ...
              <div className="km-contact-item">
                ...
                <span className="km-contact-text">
                  <a href="mailto:hello@kamaligifts.in">hello@kamaligifts.in</a>
                </span>
              </div>
